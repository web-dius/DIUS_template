...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   brandsSlider: () => (/* binding */ brandsSlider),
/* harmony export */   completedWorksSlider: () => (/* binding */ completedWorksSlider),
/* harmony export */   reviewsSlider: () => (/* binding */ reviewsSlider),
/* harmony export */   submitMasterSlider: () => (/* binding */ submitMasterSlider)
/* harmony export */ });
/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var swiper_swiper_bundle_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(37);
...
// -------переменные-----------------
window.completedWorksSliderCounter = 2.8;
window.reviewsSliderSliderCounter = 2;
window.brandsSliderCounter = 6;

//========================Слайдер Оставьте заявку на бесплатный выезд мастера=======================

function submitMasterSlider() {
    const submitMasterSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.submit-master__slider', {
        // Стрелки
        navigation: {
            nextEl: '',
            prevEl: '',
        ...
        breakpoints: {
            1220: {
                slidesPerView: window.completedWorksSliderCounter,
                spaceBetween: 30,
            },
            992: {
                slidesPerView: window.completedWorksSliderCounter - 1,
                spaceBetween: 15,
            },
            575: {
                slidesPerView: Number.isInteger(window.completedWorksSliderCounter) ? window.completedWorksSliderCounter : Math.floor(window.completedWorksSliderCounter),
                spaceBetween: 15,
            }
        },
...
//========================Слайдер Реализованные нами объекты=======================

function completedWorksSlider() {
    const completedWorksSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.completed-works__slider', {
        // Стрелки
        navigation: {
            nextEl: '.completed-works__slider-btn-next',
            prevEl: '.completed-works__slider-btn-prev',
        },
        autoHeight: true,
        /*Отступ у карточек*/
        spaceBetween: 22,
...
function reviewsSlider() {
    const reviewsSliderSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__slider', {
        // Стрелки
        navigation: {
        ...
        spaceBetween: 40,
        /*Показывать по n карточек*/
        slidesPerView: window.reviewsSliderSliderCounter - 1,

        /*Брек-поинты*/
        breakpoints: {
            1400: {
                slidesPerView: window.reviewsSliderSliderCounter,
                spaceBetween: 25,
            },
            1000: {
                slidesPerView: window.reviewsSliderSliderCounter,
...
function brandsSlider() {
    const brandsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.brands__slider', {
        // Стрелки
        navigation: {
        ...
        breakpoints: {
            1200: {
                slidesPerView: window.brandsSliderCounter,
                spaceBetween: 25,
            },
            1000: {
                slidesPerView: window.brandsSliderCounter - 2,
                spaceBetween: 15,
            },
            768: {
                slidesPerView: window.brandsSliderCounter - 3,
                spaceBetween: 15,
            },
        },
        // При достижении конца, перепрыгнуть в начало
...
/* harmony export */ });
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38);
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_loader_dist_runtime_styleDomAPI_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39);
...
/* harmony import */ var _style_loader_dist_runtime_setAttributesWithoutAttributes_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41);
/* harmony import */ var _style_loader_dist_runtime_setAttributesWithoutAttributes_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_setAttributesWithoutAttributes_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _style_loader_dist_runtime_insertStyleElement_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(42);
/* harmony import */ var _style_loader_dist_runtime_insertStyleElement_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_insertStyleElement_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43);
/* harmony import */ var _style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _css_loader_dist_cjs_js_sass_loader_dist_cjs_js_swiper_bundle_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(44);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45);
/* harmony import */ var _css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46);
/* harmony import */ var _css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(47);
/* harmony import */ var _css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__);
// Imports



var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(48), __webpack_require__.b);
...
function megaMenu() {
    ...
    const blockMenu = document.querySelector(".nav-list");
    let items = document.querySelectorAll(".nav>.nav-list>.nav-item");
    //массив элементов меню
    let menuItems = [...items];
    //скрытый элемент меню
    const opacityMenuBlock = document.querySelector(".nav__item-wrap");
    const opacityMenuWrap = document.querySelector(".nav__item-opacity");
    //ширина экрана 
    let screenWidth = window.innerWidth;
    //массив элементов меню, которые скрываются
    let opacityMenuItems = [];

    // ============частный случай============
    let subMenuWrap = document.querySelector(".sub-menu-wrap");


    //-----------после загрузки верстки первая отрисовка---------------
    window.addEventListener("load", () => {
        //начальные координаты элемента меню
        const positionStart = menuItems[0].getBoundingClientRect().top;
        for (let ix = 0; ix < menuItems.length; ix++) {
            //координаты элемента меню
            let item = menuItems[ix].getBoundingClientRect().top;
            //если элемент на другой строчке
            if (item != positionStart) {
                opacityMenuItems.push(menuItems.pop());
    ...
    window.addEventListener('resize', () => {
        ...
        for (let index = 0; index < menuItems.length; index++) {
            let item = menuItems[index].getBoundingClientRect().top;
        ...
        if (newWidth > screenWidth) {
            for (let index = opacityMenuItems.length - 1; index >= 0; index--) {
                //добавляю элемент в массив
                menuItems.push(opacityMenuItems.pop());
                //отрисовываю
                render();

                const positionStart = menuItems[0].getBoundingClientRect().top;
                let item = menuItems[menuItems.length - 1].getBoundingClientRect().top;
    ...
    function render() {
        ...
        menuItems.forEach(el => {
            ...
            blockMenu.insertAdjacentElement("beforeend", el)
        });
        blockMenu.insertAdjacentElement("beforeend", opacityMenuBlock)
        //отрисовка скрытого меню
        opacityMenuWrap.innerHTML = "";
        opacityMenuItems.forEach(el => {
            opacityMenuWrap.insertAdjacentElement("beforeend", el)
        });
    ...
    //------------------отрисовка скрытых элементов меню-------------------
    function getOpacityBlock() {
        if (opacityMenuItems.length != 0) {
            opacityMenuBlock.style.cssText = `display: flex`;
            //проверяем на одной ли строке все элементы
            for (let index = menuItems.length - 1; index >= 0; index--) {
                const positionStart = menuItems[0].getBoundingClientRect().top;
                let item = opacityMenuBlock.getBoundingClientRect().top;
            ...
            opacityMenuBlock.style.cssText = `display: none;`
        }
    }
};
megaMenu();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getSubMenu: () => (/* binding */ getSubMenu)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
function getSubMenu() {
    // ----------човер hr-------------------
    jquery__WEBPACK_IMPORTED_MODULE_0__(".nav-list>.nav-item").hover(
        function () {
            jquery__WEBPACK_IMPORTED_MODULE_0__(".hr_op").addClass("active");
        },
        function () {
            jquery__WEBPACK_IMPORTED_MODULE_0__(".hr_op").removeClass("active");
        })
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   galleryInSlider: () => (/* binding */ galleryInSlider)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);



function galleryInSlider() {
    jquery__WEBPACK_IMPORTED_MODULE_0__(".completed-works__slide-gallery-prev-img-wrap").on("click", function () {
        let src = jquery__WEBPACK_IMPORTED_MODULE_0__(this).children("img").attr('src');

        let img = jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent().prev().children();
...
/* harmony export */ });
/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53);
/* harmony import */ var _fancyapps_ui_dist_fancybox_fancybox_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54);
...
/* harmony import */ var _style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43);
/* harmony import */ var _style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _css_loader_dist_cjs_js_sass_loader_dist_cjs_js_fancybox_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(55);
...
function tabs() {
    ...
    tabs.forEach(el => {
        ...
        el.addEventListener("click", (ev) => {
            ...
            let elClasses = ev.target.className.split(" ");
            elClasses.forEach(it => {
                if (it === "tabs__title") {
...
function setInput() {
    // ----------checkbox-----------------
    jquery__WEBPACK_IMPORTED_MODULE_0__(".form__agree-lable").on("click", function () {
        jquery__WEBPACK_IMPORTED_MODULE_0__(this).toggleClass("active")
    })
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__(".calculator-input").on("input", function () {
        if (jquery__WEBPACK_IMPORTED_MODULE_0__(this).is(':checked')) {
            let name = jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr("name");

            jquery__WEBPACK_IMPORTED_MODULE_0__(`.calculator-input[name="${name}"]`).each(function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_burgerMenu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _components_slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _components_megaMenu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49);
/* harmony import */ var _components_getSubMenu_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(50);
/* harmony import */ var _components_galleryInSlider_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(51);
/* harmony import */ var _components_fancybox_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(52);
/* harmony import */ var _components_mask_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(56);
/* harmony import */ var _components_tabs_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(57);
/* harmony import */ var _components_setInput_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(58);
...
// import { setVariables } from "./components/setVariables.js";
